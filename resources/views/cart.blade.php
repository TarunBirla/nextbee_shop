...
<div class="sidebar">
    ...
    <div class="nav-section">
        ...
        <a href="/order-products" class="nav-link"><svg viewBox="0 0 24 24">
                <path
                    d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z" />
            </svg> Order Products</a>
    ...
    <div class="nav-section">
        ...
        <a href="/contacts" class="nav-link">
            <svg viewBox="0 0 24 24">
                <path
                    d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81a19.79 19.79 0 01-3.07-8.67A2 2 0 012 .82h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 8.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z" />
            </svg>
            Contact Us
        </a>
    </div>
                ...
                <div class="cart-item">
                    ...
                    <div class="item-body">
                        ...
                        <div class="item-meta">
                            ...
                            <div class="flex items-center  rounded overflow-hidden mt-2">

                                <div class="flex items-center  rounded overflow-hidden mt-2">

                                    <!-- MINUS -->
                                    <a href="/cart/decrease/{{ $item->id }}"
                                        class="px-3 py-1 bg-gray-100 hover:bg-gray-200">-</a>

                                    <!-- INPUT -->
                                    <form action="/cart/update/{{ $item->id }}" method="POST">
                                        @csrf
                                        <input type="number" name="qty" value="{{ $item->quantity }}" min="1"
                                            class="w-16 text-center border-0 focus:ring-0" onchange="this.form.submit()">
                                    </form>
                            ...
                            <span
                                style="font-size:0.75rem; color:var(--ink-muted);">£{{ number_format($item->product->price, 2) }}
                                each</span>
                        </div>
                    </div>
